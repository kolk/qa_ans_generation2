...
from onmt.models.model import NMTModel ###### TODO:REMOVE THIS LINE
...
def build_decoder(opt, embeddings):
    ...
    if opt.decoder_type == "rnn":
        ...
        if opt.input_feed:
            logger.info("pt.copy_attn" + str(opt.copy_attn))
            logger.info("opt.coverage_attn " + str(opt.coverage_attn))
            logger.info("opt.reuse_copy_attn " + str(opt.reuse_copy_attn))
